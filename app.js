...
group("matchType","type");group("arm","arm");group("singleStrap","singleStrap");group("singleStrap","singleStrap");group("tableSide","side");group("result","result");group("go","go");group("trainingArm","trainingArm");group("quality","quality");
